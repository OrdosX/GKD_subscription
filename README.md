...
[![Release](https://img.shields.io/badge/release-v422-blue)](https://github.com/Lin-arm/GKD_subscription/releases/latest)
...
[![应用规则组](https://img.shields.io/badge/应用规则组-2121-orange)](./dist/README.md#应用规则)
...
- 当前订阅文件已适配 896 个应用，共有 2121 应用规则组，3 全局规则组
...
![img](https://contrib.rocks/image?repo=Lin-arm/GKD_subscription&_v=422)
